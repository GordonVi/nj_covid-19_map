...
if (!($detect->isMobile())) {
		...
		header("Location: http://virasawmi.com/gordon/covid-19/town_graph/graph_condensed.php?a=".$leader);
...
<p style="font-size:50px"><?php echo $town; ?> (<?php echo $county; ?>)</p>
...
<hr>
			...
			<!--  Daily Change Table -->
				...
				<center><p style="font-size:100px">Daily Change</p></center>
...
<br><br><hr><br><br>
			...
			<!--  Cumulative Table -->
				...
				<center><p style="font-size:100px">Cumulative</p></center>
			...
			?>],
				...
				<center><p style="font-size:100px">Data</p></center>
...
?>
	...
	<td valign="top">
		...
		<table>
				...
				<tr><td align="right" valign="top"><b>Widescreen View:</b></td><td><a href="http://virasawmi.com/gordon/covid-19/town_graph/graph_condensed.php?a=<?php echo str_replace(" ","_",$town)."_".$county; ?>">Link to Condensed View</a></td></tr>
		</table>
